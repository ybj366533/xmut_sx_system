...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#user-plus').click(function() {
			$.post("../login.action?opt=addteacher",
				{
					name : $("#username").val(),
					sex : $("#user-sex").val(),
					age : $("#age").val(),
			...
			<div class="col-md-12 column">
				<div class="row-fluid" id="div-advanced-search">
					...
					<form class="form-inline well">
						...
						<div>
							<br> <span>邮箱:</span> <input type="email"
								class="form-control" placeholder="邮箱" id="email"> <span>手机号码:</span>
							<input type="text" class="form-control" placeholder="手机号码"
								id="mobile">
						</div>
						<div>
							<br /> <span>姓 名:</span> <input type="text" class="form-control"
								placeholder="姓名" id="username"> <span>身份证号码:</span> <input
								type="text" class="form-control" placeholder="身份证号码" id="cid">
						</div>
						<div>
							<br> <span>所属院系:</span> <select id="department"
								class="input-small" name="department">
								<%
								...
								%>
							</select> <span>用户类别:</span> <span class="placeholder" id="mtype">
								教师</span>
						</div>
						<div>
							<br /> <span>性别:</span> <input type="text" class="form-control"
								placeholder="性别" id="user-sex"> <span>年龄:</span> <input
								type="text" class="form-control" placeholder="年龄" id="age">
						</div>
				</div>
				<p>
					<br />
