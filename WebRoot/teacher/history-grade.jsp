...
Student student=Factory.getUserManageImp().select_studentByUid(uid);
Professional professional=Factory.getProfessionalManage().getProFeProfessionalById(student.getProfessionalId());
