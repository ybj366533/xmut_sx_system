...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#btn-push').click(function() {
			$.post("../test.action?opt=saveWorks", {
...
<div class="panel-body">
    ...
    <div class="input-group-btn">
      <button type="button" class="btn btn-default 
                     dropdown-toggle" data-toggle="dropdown">发布作业 <span class="caret"></span> </button>
      
    </div>
    <!-- /btn-group -->
    <input type="text" class="form-control" name="name"  height="50%" id="text-title" >
...
<div class="row">
<div class="col-md-12">
<textarea name="content" id="id-page-editor-a794381c" class="cfeditor" placeholder="请输入内容..."></textarea>
</div>
</div>
<button type="button" class="btn btn-primary" id="btn-file" data-toggle="modal" data-target="#myModal"> 上传文件 </button>
<div class="modal-footer">
        
        <button type="button" class="btn btn-default" 
               data-dismiss="modal" id="btn-text"> 验证 </button>
        <button type="submit" class="btn btn-primary" id="btn-push"> 提交 </button>
     </div>
